...
import { decreaseItem, increaseQuantity } from "../../actions/cartActions";
...
const ItemCard = ({ item }) => {
  ...
  const decrease = (obj) => {
    const product = obj.product;
    const quantity = obj.quantity;
    dispatch(decreaseItem(product, quantity, user));
  };
  const increase = (obj) => {
    const product = obj.product;
    const quantity = obj.quantity;
    dispatch(increaseQuantity(product, quantity, user));
  };
